...
public class Player : MonoBehaviour
{
    ...
    void RespondToThrustInput()
    {
        ...
        if (ControlFreak2.CF2Input.GetKey(KeyCode.W) && GameManager.Instance.boostEnerge > 0)
        {
            if (thrustPower < 0.2f)
        ...
        else if (ControlFreak2.CF2Input.GetKey(KeyCode.S) && GameManager.Instance.boostEnerge > 0)
        {
            if (thrustPower > -0.3f)
        ...
        else if (ControlFreak2.CF2Input.GetKey(KeyCode.A) && GameManager.Instance.boostEnerge > 0)
        {
        ...
        else if (ControlFreak2.CF2Input.GetKey(KeyCode.D) && GameManager.Instance.boostEnerge > 0)
        {
